...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 bg-card-subtle">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Simple, Transparent Pricing</h2>
            <p className="text-lg text-muted-foreground">
              Choose the perfect plan to grow your business online. No hidden fees, no surprises.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="border-2 border-primary shadow-xl hover:shadow-2xl transition-shadow relative">
              ...
              <CardHeader className="text-center pb-4 pt-8">
                <CardTitle className="text-2xl text-foreground mb-2">Standard</CardTitle>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader className="text-center pb-4">
                <CardTitle className="text-2xl text-foreground mb-2">Premium</CardTitle>
                <div className="text-4xl font-bold text-primary mb-2">$3,999</div>
                <CardDescription>Complete digital transformation</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center text-muted-foreground">
